# 🏆 Catálogo Oficial de Recompensas da Guilda (25 Níveis)

> **Gamers Aposentados • 100% Tributos a Obras-Primas dos Games**
> Guia mestre organizado por **Nível (1 a 25)** com prompts rigorosamente auditados para Gemini, Midjourney, Kling, Veo e DALL-E.

---

## 📁 Pastas de Destino dos Arquivos

Ao salvar os arquivos no projeto, utilize as pastas:

- **🖼️ Banners Panorâmicos (1600x400 JPG):** `public/assets/guild/banners/`
- **🐾 Mascotes (Vídeo .mp4 ou PNG/WebP):** `public/assets/guild/mascots/`
- **🛡️ Brasões (PNG Transparente 1:1):** `public/assets/guild/emblems/`
- **📜 Títulos:** Registrados nativamente no código (sem arquivo de imagem).
...
# 🚀 Guia Auditado Nível a Nível (1 a 25)

---

### 🛡️ NÍVEL 01 • Brasão: Escudo do Cavaleiro de Astora - DONE

- **Jogo:** _Dark Souls_
- **Raridade:** `COMMON`
- **Arquivo Destino:** `public/assets/guild/emblems/astora-shield.png`
- **Descrição:** _"Praise the Sun! \\[T]/ O brasão forjado em ferro e fé para os recém-chegados."_

**🎨 Prompt de Imagem (1:1):**

```text
Polished iron medieval knight crest emblem with glowing sun symbol engraved in brass, weathered steel bevels, Dark Souls Astora shield aesthetic, 3D metallic render, centered icon, sharp specular highlights, clean silhouette, isolated on pure solid black background (#000000), game UI asset --ar 1:1
```

---

### 🐾 NÍVEL 02 • Mascote: Kuro-bot (Gato Cyberpunk) - DONE

- **Jogo:** _Stray / Cyberpunk 2077_
- **Raridade:** `COMMON`
- **Arquivo Destino:** `public/assets/guild/mascots/kuro-bot.mp4` (ou `.png`)
- **Descrição:** _"Gatinho preto com visor VR holográfico, anteninha e coleira neon."_

**📸 Prompt 1: Imagem Base (Green Screen com Margem Anti-Corte):**

```text
Full body shot, centered with generous empty green padding all around, plenty of headroom above ears and antenna, character occupies only 65% of center frame, cute chibi black cat wearing a glowing cyberpunk VR headset with neon magenta and cyan visor, high-tech cybernetic collar with glowing LED cat icon, small mechanical antenna on back with glowing orb, expressive big glowing eyes, stylized 3D game character, Pixar and Overwatch render style, studio lighting, sharp crisp contour edges, isolated on solid bright green screen background (#00FF00), no floor shadows, no background smoke, high contrast, no edge cropping --ar 1:1
```

**🎬 Prompt 2: Vídeo / Animação em Loop (Sem Zoom / Sem Cortar a Cabeça):**

```text
Locked static camera, wide shot, maintain generous headroom above head and antenna, do not zoom in, do not crop head, entire character fully visible in center frame, seamless looping idle animation of a cute chibi cyberpunk black cat on a solid bright chroma green screen background (#00FF00). The cat is breathing gently, its glowing neon eyes blink softly, the antenna orb pulses with magenta light, and its tail wags slowly. Studio lighting, no camera movement, no background changes, perfectly seamless 60fps character loop.
```

---

### 🖼️ NÍVEL 03 • Banner: Bastião de Night City- DONE

- **Jogo:** _Cyberpunk 2077_
- **Raridade:** `COMMON`
- **Arquivo Destino:** `public/assets/guild/banners/night-city.jpg`
- **Efeito:** Holograma Sweep (`hologram-sweep`)
- **Descrição:** _"Acorda, Samurai! Nossa sede nunca dorme."_

**🎨 Prompt Panorâmico (4:1):**

```text
Ultra wide panoramic 4:1 banner of a rain-slicked cyberpunk metropolis skyline at midnight, glowing neon billboards in deep magenta, purple and electric cyan, flying vehicles with light trails, reflective puddles on rooftop terrace, cinematic lighting, 8k, photorealistic sci-fi environment --ar 4:1
```

---

### 📜 NÍVEL 04 • Título: Agentes da Foxhound - DONE

- **Jogo:** _Metal Gear Solid_
- **Raridade:** `COMMON`
- **Descrição:** _"Kept you waiting, huh? O esquadrão tático de operações furtivas."_
- _(Recompensa textual do sistema - não requer geração de imagem)_

---

### 🛡️ NÍVEL 05 • Brasão: Lâminas Duplas do Hadouken - DONE

- **Jogo:** _Street Fighter_
- **Raridade:** `COMMON`
- **Arquivo Destino:** `public/assets/guild/emblems/hadouken-swords.png`
- **Descrição:** _"Here comes a new challenger! A força do punho do dragão em chamas."_

**🎨 Prompt de Imagem (1:1):**

```text
Two crossed glowing steel duel swords emblem, glowing cyan and magenta energy sparks emitting from blade clash, fighting game arcade badge icon, sharp metallic texture, 3D game UI asset, centered, isolated on solid dark background (#000000) --ar 1:1
```

---

### 🐾 NÍVEL 06 • Mascote: Makar o Korok Folião - DONE

- **Jogo:** _The Legend of Zelda: The Wind Waker_
- **Raridade:** `UNCOMMON`
- **Arquivo Destino:** `public/assets/guild/mascots/makar-korok.webm` (e `makar-korok.png`)
- **Descrição:** _"Espírito da floresta Korok esculpido em madeira com máscara de folha viva, raminho na cabeça e maracas mágicas de sementes."_
...
```text
Locked static camera, 1:1 square aspect ratio, maintain generous headroom above head sprout, no zoom, no pan, character fully centered in frame. Seamless looping idle animation of the cute wooden korok companion on a solid flat bright green screen background (#00FF00). The korok joyfully sways side to side in a happy rhythmic dance, shaking its small wooden maracas in gentle rhythm, its leaf mask and head sprout bob softly, and tiny golden magical forest stardust glimmers at its feet. Perfectly centered, static camera, seamless 60fps loop.
```

---

### 🖼️ NÍVEL 07 • Banner: Cidade Subaquática de Rapture - DONE

- **Jogo:** _BioShock_
- **Raridade:** `UNCOMMON`
- **Arquivo Destino:** `public/assets/guild/banners/rapture-city.jpg`
...
- **Jogo:** _Bloodborne_
- **Raridade:** `UNCOMMON`
- **Descrição:** _"Fear the old blood. A irmandade que caça pelas ruas de Yharnam."_
- _(Recompensa textual do sistema - não requer geração de imagem)_
...
```text
Locked static camera, 1:1 square framing, maintain generous headroom above feather plume, do not zoom in, do not pan, entire cat warrior fully visible in center frame. Seamless looping idle animation of the cute chibi knight cat on a solid flat bright green screen background (#00FF00). The cat holds its wooden potion mug, breathes rhythmically, winks joyfully, its furry calico tail swishes slowly, the helmet feather plume bobs gently in the breeze, and potion bubbles sparkle softly. Studio lighting, no camera movement, zero edge cutoffs, seamless 60fps loop.
```
...
```text
Locked static camera, 1:1 square framing, maintain generous headroom above head crest, do not zoom in, do not pan, entire golden bird fully visible in center frame. Seamless looping idle animation of the cute golden mecha chick on a solid flat bright green screen background (#00FF00). The bird bobs its head cheerfully, flaps its small golden-brass wings in a rhythmic flutter, blinks its big expressive eyes, and cyan circuit lines on its body pulse softly with light. Studio lighting, no camera movement, zero edge cutoffs, seamless 60fps loop.
```
...
```text
Locked static camera, 1:1 square framing, maintain generous headroom above dragon horns and wings, do not zoom in, do not pan, entire baby dragon fully visible in center frame. Seamless looping idle animation of the cute obsidian dragon on a solid flat bright green screen background (#00FF00). The baby dragon breathes rhythmically as its molten chest cracks pulse with warm light, gently flaps its small cosmic wings, periodically sneezes a tiny puff of glowing blue magical spark, tail curls happily. Studio lighting, no camera movement, zero edge cutoffs, seamless 60fps loop.
```
...
## ⚡ Como Processar os Assets Automaticamente

Sempre que você gerar um novo vídeo ou imagem e salvar nas pastas de destino, o script de Chroma Keying nativo processa tudo com 1 comando:

```powershell
python scratch/process_green_screen.py "public/assets/guild/mascots/SEU_VIDEO.mp4" "nome-do-mascote"
```
