...
export const REWARDS_CATALOG: RewardItem[] = [
  ...
  },
  {
    ...
    type: 'FRAME',
    name: 'Bronze Shield',
    description: '"Steel is good, but bronze carries history."',
    rarity: 'UNCOMMON',
  ...
  },
  {
    ...
    type: 'BANNER',
    name: 'Retro Arcade',
    description: '"Ready? Fight! The future refused to change."',
    rarity: 'UNCOMMON',
  ...
  },
  {
    ...
    type: 'FRAME',
    name: 'Silver Crest',
    description: '"Silver for monsters, steel for humans."',
    rarity: 'RARE',
  ...
  },
  {
    ...
    type: 'THEME',
    name: 'Dark Fantasy',
    description: '"Toss a coin to your Witcher, O Valley of Plenty."',
    rarity: 'RARE',
  },
  {
    id: 'title-destruidor',
  ...
  },
  {
    ...
    type: 'BANNER',
    name: 'Blood Dragon',
    description: '"Wind\'s howling... Fus Ro Dah!"',
    rarity: 'RARE',
  ...
  },
  {
    ...
    type: 'FRAME',
    name: 'Gothic Gold',
    description: '"A hunter must hunt. Praise the Sun!"',
    rarity: 'EPIC',
  ...
  },
  {
    ...
    type: 'THEME',
    name: 'Deep Space',
    description: '"To infinity and beyond the outer rim stars."',
    rarity: 'EPIC',
  },
  {
    id: 'banner-chronos',
    ...
    type: 'BANNER',
    name: 'Chronos Temple',
    description: '"Time flows like a river, and history repeats."',
    rarity: 'EPIC',
  ...
  },
  {
    ...
    type: 'FRAME',
    name: 'Void Aura',
    description: '"Step into the Void and embrace eternity."',
    rarity: 'EPIC',
  ...
  },
  {
    ...
    type: 'FRAME',
    name: 'Phoenix Flame',
    description: '"From the ashes, legendary warriors arise."',
    rarity: 'LEGENDARY',
  ...
  },
  {
    ...
    type: 'BANNER',
    name: 'Astral Ether',
    description: '"Listen to the stream of the Planet. To the Stars!"',
    rarity: 'LEGENDARY',
  ...
  },
  {
    ...
    type: 'THEME',
    name: 'Retro Pixel',
    description: '"Press Start to relive the 16-bit golden era."',
    rarity: 'LEGENDARY',
  },
];
