...
import { Trophy, Skull, Swords, Sword, Flag, Crown, History, CheckCircle, RefreshCw, X } from "lucide-react";
...
export function QuestHistoryCard({ data, currentUserId }: QuestHistoryCardProps) {
    ...
    const bgUrl = data.winnerArtworkUrl || data.winnerImageUrl?.replace("t_cover_big", "t_1080p") || null;
    ...
    return (
        <div className="group relative z-10 mx-auto w-full overflow-hidden rounded-[2.5rem] border border-white/5 bg-zinc-950 shadow-2xl transition-all duration-700 hover:border-[#bd0df2]/20 hover:shadow-[0_0_50px_rgba(189,13,242,0.1)]">
            ...
            {bgUrl && (
                <div className="absolute inset-0 z-0 opacity-15 mix-blend-screen transition-opacity duration-700 group-hover:opacity-30 pointer-events-none">
                    <Image
                        src={bgUrl}
                        alt="Background Art"
                        fill
            ...
            <div className="absolute inset-0 z-0 bg-linear-to-b from-transparent via-zinc-950/90 to-zinc-950 pointer-events-none" />
            
            <div className="relative z-10 flex flex-col p-6 sm:p-8 lg:p-10 gap-10 lg:gap-12">
                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center lg:items-stretch">
                    ...
                    <div className="w-full sm:w-[60%] lg:w-[35%] xl:w-[30%] max-w-sm shrink-0 flex flex-col mx-auto lg:mx-0">
                        {/* Título Mobile */}
                        <div className="mb-8 flex flex-col items-center text-center lg:hidden">
                            <div className="mb-4 flex items-center justify-center gap-2">
                                <span className={cn(
                                    ...
                                    {isMainQuest ? <Crown className="size-3.5" /> : <Sword className="size-3.5" />}
                        ...
                        <div className="relative aspect-[3/4] w-full flex items-center justify-center overflow-hidden rounded-3xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.6)] transition-transform duration-700 group-hover:scale-[1.02]">
                            ...
                            {posterUrl ? (
                                ...
                                <div className="z-10 flex h-full w-full items-center justify-center bg-zinc-900">
                                    <span className="font-bold text-zinc-700 uppercase tracking-widest">Sem Arte</span>
                                </div>
                            )}
                            <div className="absolute inset-0 z-20 bg-linear-to-t from-zinc-950 via-transparent to-transparent opacity-80 pointer-events-none" />
                            <div className="absolute bottom-5 left-5 z-30 flex items-center gap-2 rounded-xl bg-zinc-950/80 px-4 py-2 backdrop-blur-md border border-white/10">
                                <Trophy className="size-5 text-amber-400" />
                                <span className="text-sm font-black tracking-widest text-amber-400 uppercase drop-shadow-[0_0_8px_rgba(251,191,36,0.5)]">Winner</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex w-full flex-col justify-center lg:w-[65%] xl:w-[70%]">
                        ...
                        <div className="flex flex-col gap-6 w-full rounded-[2rem] bg-zinc-900/40 p-6 lg:p-8 border border-white/5 backdrop-blur-xl shadow-2xl">
                            ...
                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                                {data.progress.length > 0 ? (
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="flex items-center justify-between mb-4">
                                                    <div className="flex items-center gap-3">
                                                        <div className={cn("flex size-12 items-center justify-center rounded-full bg-zinc-950 shadow-inner", statusObj.colors)}>
                                                ...
                                                <div className="mt-1">
                                                    ...
                                                    <div className="mt-3 flex justify-between px-1">
                                                        <span className="text-xs font-bold text-zinc-500 uppercase tracking-widest">Progresso</span>
                                                        <span className={cn("text-sm font-black", statusObj.colors)}>
                                                ...
                                                {p.userId === currentUserId && (
                                                    <div className="mt-5 flex flex-col gap-2">
                                                        {!isUpdating ? (
                                                                ...
                                                                <button
                                                                    ...
                                                                    className={cn(
                                                                        ...
                                                                        p.status === "COMPLETED" 
                                                                            ...
                                                                            : "bg-zinc-900/80 px-4 py-3 text-xs font-black tracking-widest text-zinc-400 uppercase border-white/10 hover:bg-zinc-800"
                                                                    )}
                                                                >
                                                            ...
                                                            <div className="flex flex-col gap-3 rounded-xl bg-zinc-950 p-4 border border-white/5 shadow-inner">
                                                                <div className="flex items-center justify-between px-1">
                                                                    <span className="text-xs font-black text-zinc-400 uppercase">
                                                                        Ajustar: <span className="text-[#bd0df2]">{percentage}%</span>
                                                                    </span>
                                                                </div>
                                                                <input 
                                                                    type="range"
                                                                    ...
                                                                    className="h-2 w-full cursor-pointer accent-[#bd0df2] bg-zinc-900 rounded-lg appearance-none"
                                                                />
                                                                <div className="flex gap-2 mt-2">
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className="flex items-center justify-center rounded-lg bg-zinc-800 px-5 transition-all hover:bg-zinc-700 text-zinc-400 hover:text-white"
                                                                    >
                                                                        <X className="size-5" />
                                                                    </button>
                                                                </div>
                                    ...
                                    <div className="col-span-1 xl:col-span-2 rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 flex items-center justify-center text-center">
                                        <span className="text-sm font-bold tracking-widest text-zinc-500 uppercase">Progresso não registrado.</span>
                                    </div>
                                )}
                            </div>
                        </div>
                ...
                <div className="w-full border-t border-white/5 pt-8 mt-2">
                    ...
                    {unanimous ? (
                        <div className="flex flex-col items-center justify-center rounded-2xl border border-white/5 bg-zinc-900/30 py-10 text-center backdrop-blur-sm">
                            ...
                            <span className="mt-2 text-xs font-bold text-zinc-500 tracking-wider">
                            ...
                            {defeatedCandidates.map((cand) => (
                                ...
                                >
                                    <div className="relative aspect-[3/4] w-full bg-zinc-950 opacity-60 grayscale transition-all duration-500 group-hover/cand:opacity-100 group-hover/cand:grayscale-0">
                                        {cand.gameImageUrl ? (
                                            ...
                                            <div className="flex h-full w-full items-center justify-center">
                                                <span className="text-[10px] font-bold text-zinc-700 uppercase tracking-widest">Sem Capa</span>
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    <div className="absolute bottom-0 left-0 flex w-full flex-col p-3 transition-transform duration-300 group-hover/cand:-translate-y-1">
                                        ...
                                        <span className="truncate text-[9px] font-bold tracking-wider text-red-400 uppercase mt-0.5">
