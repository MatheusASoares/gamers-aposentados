            ...
            >
                ...
                <div className="p-8">
                    <div className="flex flex-col items-center mb-6 text-center">
                        ...
                        <h2 className="text-2xl font-black tracking-tight">Join the Guild</h2>
                        <p className="text-muted-foreground text-sm mt-1">Create your account and start your journey.</p>
                    </div>

                    <form action={formAction} className="space-y-4">
                        <div className="space-y-2">
                            <Label className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Warrior Name</Label>
                        ...
                        <div className="space-y-2">
                            <Label className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Guild Email</Label>
                            <div className="relative group">
                        ...
                        <div className="space-y-2">
                            <Label className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Secret Code</Label>
                            <div className="relative group">
                        ...
                        <Button className="w-full bg-primary hover:bg-primary/90 font-bold py-6" disabled={isPending}>
                            {isPending ? "Creating Account..." : "Start My Adventure"}
                            {!isPending && <Zap className="ml-2 h-4 w-4" />}
                        </Button>
                    ...
                    <div className="text-center pt-6">
                        <p className="text-sm text-muted-foreground">
                            Already a member?
                            <button onClick={onSwitchToLogin} className="text-primary font-bold hover:underline ml-1">
                                Log in to your base
                            </button>
                        </p>
                    </div>
