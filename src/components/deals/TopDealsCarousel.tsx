                                    ...
                                    >
                                        <div>
                                            ...
                                            <div className="relative aspect-video w-full overflow-hidden rounded-xl bg-zinc-900 border border-theme/20">
                                                ...
                                                {isFamilyOk === true && (
                                                    <div className="absolute bottom-2 left-2 flex items-center gap-1 rounded-lg bg-purple-950/90 border border-[#bd0df2]/50 px-2 py-0.5 text-xs font-black uppercase tracking-wider text-purple-200 shadow-md backdrop-blur-sm">
